...
public class Welcome02_Object {
   public static void main(String[] args) {
	 ...
	 if (ob3.colderThan(ob1)) System.out.println("Coldest at " + id3);
	 else System.out.println("Coldest at " + id1);
      } else {
	 if (ob3.colderThan(ob2)) System.out.println("Coldest at " + id3);
	 else System.out.println("Coldest at " + id2);
      }
   }
}
